...
export const monthSelectSchema = createSelectSchema(monthTable);
export const monthInsertSchema = createInsertSchema(monthTable);
export const monthUpdateSchema = createUpdateSchema(monthTable);
...
export const hourDefinitionSelectSchema = createSelectSchema(hourDefinitionTable);
export const hourDefinitionInsertSchema = createInsertSchema(hourDefinitionTable);
export const hourDefinitionUpdateSchema = createUpdateSchema(hourDefinitionTable);
